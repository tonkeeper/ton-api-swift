...
*BlockchainAPI* | [**getBlockchainRawAccounts**](docs/BlockchainAPI.md#getblockchainrawaccounts) | **POST** /v2/blockchain/accounts/_bulk | 
...
*RewardsAPI* | [**getRewardsApy**](docs/RewardsAPI.md#getrewardsapy) | **GET** /v2/rewards/apy | Get current TON blockchain APY
*RewardsAPI* | [**getRewardsStats**](docs/RewardsAPI.md#getrewardsstats) | **GET** /v2/rewards/stats | Get historical APY and stake statistics
*RewardsAPI* | [**getRoundRewards**](docs/RewardsAPI.md#getroundrewards) | **GET** /v2/rewards/round-rewards | Get per-validator reward distribution for a finished round
*RewardsAPI* | [**getValidationRounds**](docs/RewardsAPI.md#getvalidationrounds) | **GET** /v2/rewards/validation-rounds | Get validation round metadata
*RewardsAPI* | [**getValidators**](docs/RewardsAPI.md#getvalidators) | **GET** /v2/rewards/validators | Get all current validators
...
*WalletAPI* | [**getWalletsByPublicKeyBulk**](docs/WalletAPI.md#getwalletsbypublickeybulk) | **POST** /v2/pubkeys/wallets/_bulk | 
...
## Documentation For Models
 ...
 - [BlockchainConfig30](docs/BlockchainConfig30.md)
 ...
 - [BlockchainRawAccounts](docs/BlockchainRawAccounts.md)
 ...
 - [FlawedJettonTransferAction](docs/FlawedJettonTransferAction.md)
 ...
 - [GetBlockchainRawAccountsRequest](docs/GetBlockchainRawAccountsRequest.md)
 ...
 - [NewConsensusConfig](docs/NewConsensusConfig.md)
 ...
 - [NominatorRewardEntry](docs/NominatorRewardEntry.md)
 - [Oracle](docs/Oracle.md)
 - [OracleBridgeParams](docs/OracleBridgeParams.md)
 - [OraclePriceFeed](docs/OraclePriceFeed.md)
 - [OracleRequestAction](docs/OracleRequestAction.md)
 - [PictureDNS](docs/PictureDNS.md)
 ...
 - [RewardsStats](docs/RewardsStats.md)
 - [Risk](docs/Risk.md)
 - [RoundInfo](docs/RoundInfo.md)
 - [RoundRewardsResponse](docs/RoundRewardsResponse.md)
 - [Sale](docs/Sale.md)
 ...
 - [ValidationRound](docs/ValidationRound.md)
 - [ValidationRoundsResponse](docs/ValidationRoundsResponse.md)
 - [Validator](docs/Validator.md)
 - [ValidatorRewardEntry](docs/ValidatorRewardEntry.md)
 ...
 - [WalletsByPublicKey](docs/WalletsByPublicKey.md)
 - [WalletsByPublicKeys](docs/WalletsByPublicKeys.md)
