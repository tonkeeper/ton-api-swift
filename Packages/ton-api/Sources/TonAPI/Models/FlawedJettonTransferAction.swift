//
// FlawedJettonTransferAction.swift
//
...
public struct FlawedJettonTransferAction: Codable, JSONEncodable, Hashable {
    ...
    public var sentAmount: String
    /** actually received amount in quanta of tokens */
    public var receivedAmount: String
    public var comment: String?
    public var encryptedComment: EncryptedComment?
    public var refund: Refund?
    public var jetton: JettonPreview

    public init(sender: AccountAddress? = nil, recipient: AccountAddress? = nil, sendersWallet: String, recipientsWallet: String, sentAmount: String, receivedAmount: String, comment: String? = nil, encryptedComment: EncryptedComment? = nil, refund: Refund? = nil, jetton: JettonPreview) {
        self.sender = sender
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(sentAmount, forKey: .sentAmount)
