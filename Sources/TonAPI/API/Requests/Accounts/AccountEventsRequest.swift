...
public struct AccountEventsRequest: APIRequestAttributed {
  public typealias Entity = AccountEvents
  var path: String {
    Paths.v2.accounts.accountId(accountId).events.path
  }
